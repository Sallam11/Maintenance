            ...
            modelBuilder.Entity("Maintenance.Models.Brand", b =>
                {
                    ...
                    b.Property<int>("Machine_GroupsMachineGroup_ID")
                        .HasColumnType("int");

                    b.HasKey("Brand_ID");

                    b.HasIndex("Machine_GroupsMachineGroup_ID");
            ...
            modelBuilder.Entity("Maintenance.Models.Brand", b =>
                {
                    b.HasOne("Maintenance.Models.Machine_Group", "Machine_Groups")
                        .WithMany()
                        .HasForeignKey("Machine_GroupsMachineGroup_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
